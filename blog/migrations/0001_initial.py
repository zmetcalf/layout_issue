...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NewsLayout'
        db.create_table(u'blog_newslayout', (
        ...
        db.send_create_signal(u'blog', ['NewsLayout'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'NewsLayout'
        db.delete_table(u'blog_newslayout')
    ...
    models = {
        ...
        u'blog.newslayout': {
            'Meta': {'ordering': "['-date']", 'object_name': 'NewsLayout'},
